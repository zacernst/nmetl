...
**Project**: nmetl (pycypher + nmetl)
**Version**: 0.0.19 (Alpha)
**Created**: 2026-04-09
**Framework**: Unified Multi-Agent Framework v2.0

This document systematically tracks all capabilities, features, and correctness conditions for the nmetl monorepo. Requirements are continuously validated and amended through the Meta-Improvement Protocol.
...
- **2026-09-06**: Removed [REQ-TUI-RUN-001..005] and [REQ-Q016]: the `pycypher-tui` package was deleted from the monorepo along with its tests and docs.
