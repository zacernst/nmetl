...
class TestDataModelColumnMappingIntegration:
    ...
    def test_relationship_validation_tab_setup(
        self, mock_config_manager, relationship_node
    ):
        ...
        with (
            patch.object(panel, "query_one") as mock_query,
    ...
    def test_mapping_change_handling(
        self, mock_config_manager, relationship_node
    ):
    ...
    def test_data_model_screen_integration(self, mock_config_manager):
        ...
        relationship_nodes = [
            item for item in items if item.node_type == "relationship"
        ]
    ...
    def test_detail_panel_creation_and_update(
        self, mock_config_manager, relationship_node
    ):
