...
def _sample_entities():
    return [
        EntityTableInfo(
            "customers_csv", "Customer", "data/customers.csv", "id", {}, False
        ),
        EntityTableInfo(
            "orders_csv", "Order", "data/orders.csv", "order_id", {}, True
        ),
    ]
...
class TestDataPreviewDialog:
    def test_dialog_stores_source_uri(self):
        ...
        dialog = DataPreviewDialog(
            source_uri="data/test.csv", source_id="test_csv"
        )
...
class TestSchemaTabFix:
    def test_update_schema_tab_is_not_generator(self):
        ...
        assert not inspect.isgeneratorfunction(
            DataPreviewDialog._update_schema_tab
        )
    ...
    def test_update_data_tab_is_not_generator(self):
        ...
        assert not inspect.isgeneratorfunction(
            DataPreviewDialog._update_data_tab
        )
    ...
    def test_update_stats_tab_is_not_generator(self):
        ...
        assert not inspect.isgeneratorfunction(
            DataPreviewDialog._update_stats_tab
        )
