...
class QueryEditorScreen(Screen):
    ...
    class EditorClosed(Message):
        ...
        def __init__(
            self, query_text: str, query_id: str | None = None
        ) -> None:
            super().__init__()
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="editor-footer"):
            with Horizontal():
                yield Label(
                    "NORMAL", id="editor-mode-label", classes="mode-normal"
                )
    ...
    def _update_position_display(self) -> None:
        ...
        try:
            ...
            logger.debug(
                "_update_position_display: #editor-position-label not found"
            )
    ...
    def _save_query(self) -> None:
        ...
        if self._query_id:
            ...
            try:
                ...
                logger.debug(
                    "_save_query: query %s not found for removal",
                    self._query_id,
                )
