...
class PipelineTemplate:
    ...
    parameters: list[str] = field(
        default_factory=lambda: ["project_name", "data_dir"]
    )
    ...
    return PipelineConfig(
        ...
        output=[
            OutputConfig(
                ...
                uri=f"{data_dir}/output/summary.csv",
            ),
        ],
    )
    ...
    return PipelineConfig(
        ...
        output=[
            OutputConfig(
                ...
                uri=f"{data_dir}/output/top_products.csv",
            ),
            OutputConfig(
                query_id="customer_spend", uri=f"{data_dir}/output/spend.csv"
            ),
        ],
    )
...
def _build_social_network(
    ...
    **_: str,
    ...
    return PipelineConfig(
        ...
        output=[
            OutputConfig(
                query_id="influencers",
                uri=f"{data_dir}/output/influencers.csv",
            ),
        ],
    )
...
def _build_time_series(
    ...
    **_: str,
    ...
    return PipelineConfig(
        ...
        output=[
            OutputConfig(
                query_id="sensor_summary",
                uri=f"{data_dir}/output/sensor_summary.csv",
            ),
        ],
    )
