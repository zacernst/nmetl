...
class Star:
    ...
    def __init__(
        ...
        *,
        ...
        # star import cycle).
        context.set_subquery_executor(
            _StarSubqueryExecutor(self._clause_executor)
        )
        ...
        *,
        ...
        with self.context.scoped_execution():
            ...
            try:
                ...
                if result is None:
                    result = pd.DataFrame()
                parsed_query = _pipeline_result.metadata.get(
                    "parsed_ast", query
                )
                _is_mutation = _pipeline_result.metadata.get(
                    "is_mutation", False
                )
