...
class TestRelationshipSourceConfig:
    def test_endpoint_entity_types_are_optional_and_round_trip(self) -> None:
        r = RelationshipSourceConfig(
            id="housing_in_puma",
            uri="file:///data/psam_hus.parquet",
            relationship_type="LOCATED_IN",
            source_col="SERIALNO",
            target_col="PUMA_FIPS",
        )
        ...
        assert r.source_entity_type == "HousingSurvey1yr"
        assert r.target_entity_type == "PUMA"
...
"""
    ...
    def test_skip_policy_populates_skipped_audit_trail(
        ...
        from nmetl.config import SkippedSource
