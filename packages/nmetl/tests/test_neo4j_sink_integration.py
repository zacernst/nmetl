"""Integration tests for nmetl.sinks.neo4j.

These tests require a live Neo4j instance.  They are skipped automatically
when Neo4j is unreachable or the driver package is absent.  Neo4j is not
part of this repo's Docker Compose stack -- point them at your own instance.

Run against your own Neo4j instance::

    export NEO4J_URI=bolt://localhost:7687
    export NEO4J_PASSWORD=secret
    uv run pytest packages/nmetl/tests/test_neo4j_sink_integration.py -m neo4j -v

Or run the full suite (these self-skip if no instance is reachable)::
...
import pandas as pd
import pytest
from nmetl.sinks.neo4j import Neo4jSink, NodeMapping, RelationshipMapping
