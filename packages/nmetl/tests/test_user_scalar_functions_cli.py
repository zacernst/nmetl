...
sources:
  entities:
    - id: people
      ...
      id_col: __ID__
functions:
  - callable: packages.nmetl.tests.fixtures.user_scalar_module.shout
queries:
  - id: q1
...
""",
            ...
            assert (
                "registered packages.nmetl.tests.fixtures.user_scalar_module.shout"
                in (result.output)
            )
...
sources:
  entities:
    - id: people
      ...
      id_col: __ID__
functions:
  - module: packages.nmetl.tests.fixtures.user_scalar_module
    names:
      - plus_n
queries:
  - id: q1
...
""",
            ...
            assert (
                "registered packages.nmetl.tests.fixtures.user_scalar_module.plus_n"
                in (result.output)
            )
...
sources:
  entities:
    - id: people
      ...
      id_col: __ID__
functions:
  - callable: packages.nmetl.tests.fixtures.user_scalar_module.does_not_exist
queries:
  - id: q1
    source: file://{cypher_path}
output:
