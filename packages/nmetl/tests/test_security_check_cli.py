...
from nmetl.cli.main import cli
from nmetl.cli.security import (
    SecurityReport,
    Severity,
    scan_config,
)
...
class TestFinding:
    def test_finding_fields(self):
        from nmetl.cli.security import Finding
...
class TestCheckEnvVarPatterns:
    ...
    def test_secret_env_var_names(self, var_name):
        ...
        from nmetl.cli.security import _check_env_var_patterns
...
class TestScanConfigOutputSinks:
    ...
    def test_http_in_output_uri(self):
        ...
        from nmetl.cli.security import _check_uri_security
