...
# Health status reads process-global state (metrics collector, RSS); see
# the fixture for why every test here must start from a clean slate.
...
class TestHealthServer:
    ...
    def _start_health_server() -> tuple[Any, int]:
        ...
        from nmetl.health_server import _HealthHandler
