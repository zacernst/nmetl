"""High-level, undoable pipeline configuration API.

``PipelineBuilder`` wraps :class:`~nmetl.config.PipelineConfig`
...
class PipelineBuilder:
    """High-level, undoable pipeline configuration builder.
