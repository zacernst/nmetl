...
def _format_validation_errors(
    ...
    Delegates to :func:`nmetl.cli.common.format_validation_errors`.
    """
    from nmetl.cli.common import format_validation_errors
...
def _translate_duckdb_error(exc: BaseException, kind: str, path: str) -> str:
    ...
    Delegates to :func:`nmetl.cli.common.translate_duckdb_error`.
    """
    from nmetl.cli.common import translate_duckdb_error
...
def _load_config(config: Path, *, verbose: bool = False) -> Any:
    ...
    """
    from nmetl.config import load_pipeline_config
...
@click.group()
@click.version_option(package_name="nmetl")
@click.option(
    "-v",
    "--verbose",
    is_flag=True,
...
def _dry_run_validate(
    ...
    *,
    ...
    """Backward-compatible wrapper — delegates to :mod:`nmetl.cli.pipeline`."""
    from nmetl.cli.pipeline import dry_run_validate
...
def run(
    ...
    """
    from nmetl.cli.pipeline import run_impl
...
def validate(config: Path, verbose: bool) -> None:
    ...
    """
    from nmetl.cli.pipeline import validate_impl
...
def list_queries(config: Path, *, deps: bool) -> None:
    ...
    """
    from nmetl.cli.pipeline import list_queries_impl
...
def functions(
    *,
    ...
    """
    from nmetl.cli.schema import functions_impl
...
def parse(cypher_query: str, *, as_json: bool, run_validation: bool) -> None:
    ...
    """
    from nmetl.cli.query import parse_impl
...
from nmetl._cli_query import (  # noqa: E402  # avoiding circular import via _cli_query
...
def schema(
    ...
    """
    from nmetl.cli.schema import schema_impl
...
def metrics(*, as_json: bool, diagnostic: bool) -> None:
    ...
    """
    from nmetl.cli.system import metrics_impl
...
def config_cmd(*, as_json: bool) -> None:
    ...
    """
    from nmetl.cli.system import config_impl
...
def health(*, as_json: bool, verbose_health: bool) -> None:
    ...
    """
    from nmetl.cli.system import health_impl
...
def health_server(*, port: int, bind: str) -> None:
    ...
    """
    from nmetl.cli.system import health_server_impl
...
def format_query_cmd(
    ...
    *,
    ...
    """
    from nmetl.cli.query import format_query_impl
...
def repl(
    ...
    """
    from nmetl.cli.interactive import repl_impl
...
def compat_check(
    *,
    ...
    """
    from nmetl.cli.utility import compat_check_impl
...
# - Common utilities extracted to nmetl.cli.common
# - Pipeline commands in nmetl.cli.pipeline
# - Query commands in nmetl.cli.query
# - Schema commands in nmetl.cli.schema
# - System commands in nmetl.cli.system
# - Interactive commands in nmetl.cli.interactive
# - Utility commands in nmetl.cli.utility
#
# Run with: python -m nmetl.cli.main
# ---------------------------------------------------------------------------
