...
class TestDataPreviewDialog:
    ...
    def test_dialog_initialization(self, sample_csv_file):
        ...
        dialog = DataPreviewDialog(
            source_uri=str(sample_csv_file), source_id="test_csv"
        )
    ...
    def test_dialog_with_invalid_file(self):
        ...
        dialog = DataPreviewDialog(
            source_uri="/nonexistent/file.csv", source_id="invalid_csv"
        )
...
class TestDataSourcesScreenIntegration:
    ...
    def test_screen_override_keys_include_preview(
        self, config_manager_with_sources
    ):
    ...
    def test_handle_extra_key_preview(
        self, config_manager_with_sources, monkeypatch
    ):
...
class TestDataPreviewIntegration:
    ...
    def test_preview_csv_file(self, sample_data_files):
        ...
        dialog = DataPreviewDialog(
            source_uri=str(csv_file), source_id="products"
        )
    ...
    def test_preview_json_file(self, sample_data_files):
        ...
        dialog = DataPreviewDialog(
            source_uri=str(json_file), source_id="orders"
        )
    ...
    def test_preview_nonexistent_file(self):
        ...
        dialog = DataPreviewDialog(
            source_uri="/tmp/nonexistent.csv", source_id="missing"
        )
